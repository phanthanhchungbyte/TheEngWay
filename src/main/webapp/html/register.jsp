        ...
        <div>
            <nav class="top-nav">
                ...
                <div class="buttons">
                    ...
                    <a href="../html/register.jsp"><button>Đăng ký</button></a>
                </div>
            </nav>
        </div>
                    ...
                    <div class="register-input">
                        <form>
                            ...
                            <div class="input-group">
                                ...
                                <div class="input"><input type="password" id="confirm-password" name="confirm-password" placeholder="Xác nhận mật khẩu"></div>
                            </div>
                            <div class="input-group">
                                <i class="fas fa-envelope fa-2x"></i>
                                <div class="label"><label for="password">Email</label></div>
                                <div class="input"><input type="text" id="email" name="email" placeholder="Email"></div>
                            </div>
