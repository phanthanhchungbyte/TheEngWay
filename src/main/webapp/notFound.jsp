...
<div class="container">
                ...
                <ul class="menu-items">
                    <li class="search">
                        <form action="${pageContext.request.contextPath}/actSearchLessonServlet" method="get">
                            ...
                            <input class="search-bar" id="search-bar" name="searchString" placeholder="Search lessons diffirent" onkeyup="searchSuggestions()">
    ...
    <section class="skill-content">
        <div class="content-title">
            <h1 style="background-color: #008a9d">NOT FOUND LESSON</h1>
        </div>
    </section>
